...
UserConf.prototype.init = function () {
...
* - 設定情報を格納したハッシュオブジェクト
* ---------------------------------------------------------------- */
UserConf.prototype.get = function () {
...
*          |          | 成功の場合は存在しない
* ---------------------------------------------------------------- */
UserConf.prototype.set = function (in_data) {
...
UserConf.prototype._checkValues = function (in_data) {
	let data = {};
	let errs = {};
