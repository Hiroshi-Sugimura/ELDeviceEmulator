...
PacketLogger.prototype._log = function (direction, address, parsed) {
	if (!parsed) {
		return;
	}
...
PacketLogger.prototype._error = function (direction, address, parsed) {
	if (!parsed) {
		return;
	}
...
PacketLogger.prototype._getTimeStamp = function (dt) {
	let date = this._getDate(dt);
...
PacketLogger.prototype._getDate = function (dt) {
...
PacketLogger.prototype._getTime = function (dt) {
...
PacketLogger.prototype._getTz = function (dt) {
...
PacketLogger.prototype._zeroPadding = function (n) {
	return ('0' + n).slice(-2);
};

PacketLogger.prototype._delteOldLogFiles = function () {
